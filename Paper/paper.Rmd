...
28. 	CBS Statline (2022) Kerncijfers wijken en buurten 2022. In: Centraal Bureau voor de Statistiek. https://opendata.cbs.nl. Accessed 6 Apr 2023
...
\begin{figure}[]
  \centering
  \includegraphics[width=.8\linewidth]{figures/Economic_Value_Urban_Green_clip.png}
  \caption{Overview of Statistically Significant Urban Green Space Coefficients, i.e. NDVI at a 300m Spatial Scale, (p < 0.05) in Amsterdam.}
\end{figure}
```
