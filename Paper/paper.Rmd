...
# 3. Results and Discussion
  ...
  Results of the local regression revealed that urban green spaces were significantly associated with residential house prices at a 300m spatial scale (p < 0.05). Here, property premiums per m2 ranged from -82,657.5 to 125,978.4 euros for each unit increase in the vegetation index. These results align with previous studies, highlighting the non-stationary nature of the association of interest [23, 36, 39, 40]. As a result, the findings of this study provide empirical evidence of the capitalisation of greenness characteristics in residential property prices. 
